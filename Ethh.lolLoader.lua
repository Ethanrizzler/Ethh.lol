    Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/violin-suzutsuki/LinoriaLib/refs/heads/main/Library.lua'))() -- The Ui Lib
    ...
    Title = 'Ethh.lol| Lyo.exe ahh lock',
    Center = true,
    AutoShow = true,
    TabPadding = 9
    })
